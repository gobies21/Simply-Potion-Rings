...
public class RingRegenerationItem extends Item implements ICurioItem {
    public RingRegenerationItem(Properties properties) {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        int ringCount = RingHandler.getEquippedRingCount(entity, PRItems.PotionRingRegeneration.get());

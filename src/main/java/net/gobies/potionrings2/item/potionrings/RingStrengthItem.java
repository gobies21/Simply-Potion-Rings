...
public class RingStrengthItem extends Item implements ICurioItem {
    public RingStrengthItem(Properties properties) {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        int ringCount = RingHandler.getEquippedRingCount(entity, PRItems.PotionRingStrength.get());

...
public class RingHasteItem extends Item implements ICurioItem {
    public RingHasteItem(Properties properties) {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        int ringCount = RingHandler.getEquippedRingCount(entity, PRItems.PotionRingHaste.get());
